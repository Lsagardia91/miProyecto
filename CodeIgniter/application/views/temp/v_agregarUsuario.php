                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-md-offset-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php echo form_open_multipart("C_usuario/agregarbd"); ?>
                            <div class="form-group">
                                <input type="text" class="form-control" name="nombresv" placeholder="Escribe el nombre" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="apellidosv" placeholder="Escribe los apellidos" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="direccionv" placeholder="Escribe la dirección" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="telefonov" placeholder="Escribe el teléfono" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="carnetIdentidadv" placeholder="Escribe el carnet de identidad" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="generov" placeholder="Escribe el género" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="estadov" placeholder="Escribe el estado" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="userNamev" placeholder="Escribe el usuario" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="passwordv" placeholder="Escribe el password" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="rolv" placeholder="Escribe el rol" required>
                            </div>
