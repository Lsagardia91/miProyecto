                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-md-offset-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php foreach($infolibro->result() as $row) { ?>
                            <?php echo form_open_multipart("C_libro/modificarbd"); ?>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="autorv" placeholder="Escribe el autor" value="<?php echo $row->autor; ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="isbnv" placeholder="Escribe el ISBN" value="<?php echo $row->isbn; ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="anioPublicacionv" placeholder="Escribe el año de publicación" value="<?php echo $row->anioPublicacion; ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="categoriav" placeholder="Escribe la categoría" value="<?php echo $row->categoria; ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="editorialv" placeholder="Escribe la editorial" value="<?php echo $row->editorial; ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="dewayv" placeholder="Escribe el código Dewey" value="<?php echo $row->dewey; ?>" required>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="cutterv" placeholder="Escribe el código Cutter" value="<?php echo $row->cutter; ?>" required>
                            </div>
